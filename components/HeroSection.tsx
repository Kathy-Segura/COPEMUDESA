...
export default function HeroSection() {
  ...
  const images: CarouselImage[] = [
    ...
    {
      main: "/granosbasicosejemplo.jpg?height=600&width=400",
      topRight: "/hortalizasejemplo.jpg?height=200&width=200",
      bottomRight: "/cafe.jpg?height=300&width=200",
    ...
    {
      main: "/hortalizasejemplo.jpg?height=600&width=400",
      topRight: "/cafe-oro.jpeg??height=200&width=200",
      bottomRight: "/granosbasicosejemplo.jpg?height=300&width=200",
